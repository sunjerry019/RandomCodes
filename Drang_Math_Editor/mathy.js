...
var load =
{
    "check": function (loadanot)
    {
        ...
        if (typeof MathLex == 'undefined')
        {
            ...
            if (loadanot) if (load.script("https://raw.githubusercontent.com/mathlex/mathlex/master/info-page/javascripts/mathlex.js")) console.log("MathLex now loaded");
        }
        else scripts++;
        ...
        if (typeof MathJax == 'undefined')
        {
            ...
            if (loadanot) if (load.script("https://cdn.mathjax.org/mathjax/latest/MathJax.js?config=TeX-AMS-MML_HTMLorMML")) console.log("MathJax now loaded");
        }
        else scripts++;
